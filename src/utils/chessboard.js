...
(function () {
  ...
  function constructor(containerElOrString, config) {
    ...
    // move pieces
    // TODO: this method should be letiadic as well as accept an array of moves
    ...
    let throttledMousemoveWindow = throttle(
      mousemoveWindow,
    ...
    let throttledTouchmoveWindow = throttle(
      touchmoveWindow,
      config.dragThrottleRate
    );
